...
- (void)setControllers
{
    ...
    UINavigationController *homeNav = [self controller:homeVC Title:@"门锁管理" tabBarItemImage:@"门锁管理未选中" tabBarItemSelectedImage:@"门锁管理选中"];
 ...
 * 直接调用这个方法就可以了
 */
- (UINavigationController *)controller:(UIViewController *)controller Title:(NSString *)title tabBarItemImage:(NSString *)image tabBarItemSelectedImage:(NSString *)selectedImage
{
