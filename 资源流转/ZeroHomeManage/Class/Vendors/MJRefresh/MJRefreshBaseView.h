...
@interface MJRefreshBaseView : UIView
{
    ...
    __weak UIImageView *_footImageView;
    __weak UILabel *_footStatusLabel;
...
@property (nonatomic, weak, readonly) UIImageView *footImageView;
@property (nonatomic, weak, readonly) UILabel *footStatusLabel;
