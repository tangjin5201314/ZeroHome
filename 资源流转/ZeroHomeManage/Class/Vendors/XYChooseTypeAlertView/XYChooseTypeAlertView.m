...
//        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        ...
        CGFloat tbH = _titleArr.count * cellH+50;
        if (tbH > screenH *0.7){
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    XYChooseAlertTableViewCell *cell = (XYChooseAlertTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
    cell.cicleImage.image = [UIImage imageNamed:@"Selectedadd.png"];
...
{
    UIView *headView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, tableView.width, 50)];
    
    UILabel *message_lbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, headView.width, headView.height)];
    message_lbl.textColor = HexRGB(0x999999);
    message_lbl.font = Font(16);
    message_lbl.numberOfLines = 0;
    message_lbl.text = self.headMessage;
    message_lbl.textAlignment = NSTextAlignmentCenter;
    [headView addSubview:message_lbl];
    return headView;
}
